...
<Callout type="tip" title="Want to customise before scaffolding?">
  The [contract wizard](/docs/templates/wizard) builds a token, NFT, or counter
  from feature toggles with a live preview, then scaffolds the same kind of bundle.
</Callout>
